...
function getDisplayTitle(event: EventView) {
  return event.displayTitle ?? "(untitled event)"
}
      ...
      <Tabs defaultValue="endpoints" className="gap-4">
        ...
        <TabsContent value="endpoints">
          <Card>
            <CardHeader>
              <div>
                <CardTitle>{sourceDisplay.providerName}</CardTitle>
                <CardDescription>{sourceDisplay.endpointDescription}</CardDescription>
              </div>
              <CardAction>
                <Badge
                  variant={
            ...
            <CardContent className="flex flex-col gap-4">
              <div className="grid gap-3 sm:grid-cols-[140px_1fr_auto] sm:items-center">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-muted-foreground text-xs">
                    {sourceDisplay.setupInstruction}
                  </span>
                </div>
                <Button
                  variant="outline"
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-muted-foreground text-xs">
                    {sourceDisplay.verificationInstruction}
                  </span>
                </div>
                  ...
                  <Input
                    ...
                    placeholder={
                      endpoint?.hasVerificationSecret
                        ...
                        : sourceDisplay.secretPlaceholder
                    }
        ...
        <TabsContent value="routing">
          <Card>
            <CardHeader>
              <CardTitle>
                {sourceDisplay.providerName} {sourceDisplay.routingTitle}
              </CardTitle>
              <CardDescription>{sourceDisplay.routingDescription}</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-4">
        ...
        <TabsContent value="events">
          <Card>
            <CardHeader>
              ...
              <CardDescription>{sourceDisplay.eventsDescription}</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <tbody>
                    {events.map((event) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2">{event.targetAgent ?? "-"}</td>
